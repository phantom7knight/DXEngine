...
bool ColorShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	//The data which we want to send to the shader
	//=====================================================
	...
	XMMATRIX projectionMatrix)
{
	...
	//This is to lock the constant buffer and setting up the matrices inside it and 
	// we will unlock it using Unmap()
...
void ColorShaderClass::RenderShader(ID3D11DeviceContext* deviceContext, int indexCount)
{
	...
	//Set the vertex and Pixel shaders for rendering of Triangle
