...
bool D3DClass::Initialize(int screenWidth, int screenHeight, bool vsync, HWND hwnd, bool fullscreen, float screenDepth, float screenNear)
{
	...
	//Set the V-Sync using swapchain
	if (m_vsync_enabled)
	{
	...
	//Set the swap chain to the render target view
	...
	//=====================================================================
	//Stencil is used to achieve the effects such as motion blur,
	// volumetric shadows
	//=====================================================================
	...
	//stencil operations if front facing
	depthStencilDesc.FrontFace.StencilFailOp = D3D11_STENCIL_OP_KEEP;
	depthStencilDesc.FrontFace.StencilDepthFailOp = D3D11_STENCIL_OP_INCR;
	depthStencilDesc.FrontFace.StencilPassOp = D3D11_STENCIL_OP_KEEP;
	depthStencilDesc.FrontFace.StencilFunc = D3D11_COMPARISON_ALWAYS;

	//stencil operations if back facing
	...
	//Binds depth stencil with render target
	...
	//========================================================================
	//Clearing the Depth Stencil State before setting parameters
	//========================================================================
